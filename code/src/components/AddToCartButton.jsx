...
import addToCart from "@utils/addToCart"; // mantiene tu lógica
import cartSVG from "../assets/add-one-cart.svg?raw"; // ✅ funciona igual que en Astro con Vite

export default function AddToCartButton({ producto: p }) {
